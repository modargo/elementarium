...
{
    public static final String ID = "Elementarium:VoidCorruption";
    ...
    private static final int VOIDS_ATTACK_DAMAGE = 11;
    private static final int A2_VOIDS_ATTACK_DAMAGE = 13;
    ...
    private static final int A7_HP_MIN = 97;
    ...
    static {
        ...
        NAME = VoidCorruption.monsterStrings.NAME;
        MOVES = VoidCorruption.monsterStrings.MOVES;
    }
}