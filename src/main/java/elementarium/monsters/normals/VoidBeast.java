...
import elementarium.powers.VoidPressurePower;

public class VoidBeast extends CustomMonster
{
    public static final String ID = "Elementarium:VoidBeast";
    ...
    static {
        ...
        NAME = VoidBeast.monsterStrings.NAME;
        MOVES = VoidBeast.monsterStrings.MOVES;
    }
}