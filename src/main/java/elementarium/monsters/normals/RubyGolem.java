...
public class RubyGolem extends CustomMonster
{
    ...
    private static final int PRISM_DAMAGE = 7;
    private static final int A2_PRISM_DAMAGE = 8;
    ...
    private static final int A7_HP_MIN = 84;
    private static final int A7_HP_MAX = 88;
