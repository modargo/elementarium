...
import elementarium.powers.HoverPower;

public class LivingStormcloud extends CustomMonster
{
    public static final String ID = "Elementarium:LivingStormcloud";
    ...
    private static final int GUST_ATTACK_DAMAGE = 6;
    ...
    static {
        ...
        NAME = LivingStormcloud.monsterStrings.NAME;
        MOVES = LivingStormcloud.monsterStrings.MOVES;
    }
}