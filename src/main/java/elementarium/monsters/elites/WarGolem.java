...
{
    public static final String ID = "Elementarium:WarGolem";
    ...
    private static final int A3_DEX_ATTACK_DAMAGE = 16;
    ...
    private static final int A8_HP_MIN = 87;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case VULNERABLE_ATTACK: {
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new DelayedVulnerablePower(AbstractDungeon.player, this.vulnerableAmount), this.vulnerableAmount));
                break;
            }
            case FRAIL_ATTACK: {
                AbstractDungeon.actionManager.addToBottom(new AnimateSlowAttackAction(this));
    ...
    static {
        ...
        NAME = WarGolem.monsterStrings.NAME;
        MOVES = WarGolem.monsterStrings.MOVES;
    }
}