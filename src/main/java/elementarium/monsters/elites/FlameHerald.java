...
public class FlameHerald extends CustomMonster
{
    ...
    private static final int A8_GATHERING_FLAMES_BLOCK = 6;
    private static final int GATHERING_FLAMES_HEAL = 4;
    private static final int A18_GATHERING_FLAMES_HEAL = 8;
    private static final int SPEAR_THRUST_DAMAGE = 10;
    private static final int A3_SPEAR_THRUST_DAMAGE = 12;
    ...
    private static final int PROTECTING_SLAM_DAMAGE = 8;
    private static final int A3_PROTECTING_SLAM_DAMAGE = 10;
    ...
    private static final int A8_HP_MIN = 93;
