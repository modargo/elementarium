...
import elementarium.monsters.normals.LivingStormcloud;
import elementarium.monsters.normals.OpulentOffering;
import elementarium.monsters.normals.OrbOfFire;
import elementarium.monsters.normals.ShimmeringMirage;
import elementarium.powers.SummoningPortalPower;
...
public class ElementalPortal extends CustomMonster
{
    ...
    public static final String ID = "Elementarium:ElementalPortal";
    ...
    private static final int A8_HP_MIN = 52;
    private static final int A8_HP_MAX = 57;
    ...
    static {
        ...
        NAME = ElementalPortal.monsterStrings.NAME;
        MOVES = ElementalPortal.monsterStrings.MOVES;
    }
}
