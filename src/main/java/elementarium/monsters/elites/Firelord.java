...
public class Firelord extends CustomMonster
{
    ...
    private static final int HAMMER_OF_THE_FIRELORD_DAMAGE = 14;
    private static final int A3_HAMMER_OF_THE_FIRELORD_DAMAGE = 16;
    ...
    private static final int RAIN_OF_FIRE_DAMAGE = 3;
    private static final int A3_RAIN_OF_FIRE_DAMAGE = 3;
